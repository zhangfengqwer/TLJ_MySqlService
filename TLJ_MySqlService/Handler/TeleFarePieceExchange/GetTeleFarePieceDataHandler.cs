...
{
    [Handler(Consts.Tag_HuaFeiSuiPianDuiHuanData)]
    class GetTeleFarePieceDataHandler : BaseHandler
    {
        ...
        private void OperatorSuccess(JObject responseData)
        {
            ...
            responseData.Add("dataList", JsonConvert.SerializeObject(MySqlService.teleFarePieceDatas));
        }
